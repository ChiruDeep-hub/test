          ...
          <div className="space-y-10">
            ...
            {(reviewData || (reviewList && reviewList.length > 0)) && (
              <div className="space-y-4">
                {(reviewList.length > 0 || reviewData) && (
  <div className="space-y-4">
    
    {/* SHOW ONLY CURRENT REVIEW */}
    <ReviewCard
      key={
        reviewList.length > 0
          ? reviewList[currentReviewIndex]?.id
          : reviewData?.id
      }
      review={
        reviewList.length > 0
      ...
      onAccept={(id, sectionStates) =>
        handleFeedbackSubmitForReview(id, 'positive', null, sectionStates)
      }
